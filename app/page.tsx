...
export const metadata: Metadata = {
  title: "NUX Mighty Plug Pro Patches – Free Guitar Presets Library | NX Rig",
  description:
    "Download free NUX Mighty Plug Pro patches and guitar presets. Explore authentic tones for rock, blues, and metal. Easy to use, tested by real musicians.",
  openGraph: {
    title: "NUX Mighty Plug Pro Patches – Free Guitar Presets Library | NX Rig",
    description:
      "Download free NUX Mighty Plug Pro patches and guitar presets. Explore authentic tones for rock, blues, and metal. Easy to use, tested by real musicians.",
